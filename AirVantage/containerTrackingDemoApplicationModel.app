    ...
    <data>
      <encoding type="MQTT">
        <asset default-label="Application" id="a">
          <node default-label="Bluetooth" path="bt">
            <node default-label="Commands" path="commands">
            ...
            <node default-label="Readings" path="read">
              <node default-label="Movement" path="movement">
                <node default-label="Accelerometer" path="accelerometer">
                  <variable
                      default-label="Sensors/Movement/Accelerometer/X" path="x" type="double"/>
                  <variable
                      default-label="Sensors/Movement/Accelerometer/Y" path="y" type="double"/>
                  <variable
                      default-label="Sensors/Movement/Accelerometer/Z" path="z" type="double"/>
                </node>
                <node default-label="Magnetometer" path="magnetometer">
                  <variable
                      default-label="Sensors/Movement/Magnetometer/X" path="x" type="double"/>
                  <variable
                      default-label="Sensors/Movement/Magnetometer/Y" path="y" type="double"/>
                  <variable
                      default-label="Sensors/Movement/Magnetometer/Z" path="z" type="double"/>
                </node>
